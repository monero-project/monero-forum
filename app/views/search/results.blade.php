	...
	@foreach($results as $result) 
		<div class="panel panel-default thread-block">
		  <div class="panel-heading">
		    <h3 class="panel-title"><span class="glyphicon glyphicon-comment"></span>{{{ $result->name }}} <span class="post-meta"> <a class="poster-name" href="{{ 'lala' }}" target="_blank">THREAD <span class="glyphicon glyphicon-new-window"></span>
