...
<div class="post-indent">
	...
	@endif
		...
		@foreach (($breadcrumbs) as $key => $breadcrumb)
			<a class="post-crumb" href="#post-{{ $breadcrumb->id }}" data-toggle="tooltip" data-placement="top" title="{{ str_limit(e($breadcrumb->body), 200, '...') }}" alt="{{ str_limit(e($breadcrumb->body), 200, '...') }}">{{ $breadcrumb->user->username }}</a>@if (sizeof($breadcrumbs)-1 != $key)<i class="fa fa-angle-right reply-bullet"></i>@endif
		@endforeach
		</div>
		@if (
		!$post->deleted_at
