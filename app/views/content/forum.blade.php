  ...
  <div class="panel-body thread-list">
    ...
    <div class="row">
	    <div class="col-md-6">
	    	...
	    	@else
	    	    @if ( $thread->new_posts )
	    	    <img data-toggle="tooltip" data-placement="top" data-original-title="{{{ $thread->unread_posts }}}" src="//static.monero.cc/images/icon_thread_new.png">
	            @else
	    	    <img src="//static.monero.cc/images/icon_thread.png">
	    	    @endif
