...
class ForumsController extends \BaseController {
	...
	{
		$threads = Thread::where('is_queued', false)->where('forum_id', '=', $forum_id)->orWhere('moved', $forum_id)->whereNull('deleted_at')->orderBy('updated_at', 'DESC')->paginate(Config::get('app.threads_per_page'));
